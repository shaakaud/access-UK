...
if has("cscope")
    ...
    nmap <F5> :cs find t <C-R>=expand("<cword>")<CR><CR>
    nmap <F6> :cs find e <C-R>=expand("<cword>")<CR><CR>
    nmap <F7> :cs find f <C-R>=expand("<cfile>")<CR><CR>
    nmap <F8> :cs find i ^<C-R>=expand("<cfile>")<CR>$<CR>
    nmap <F9> :cs find d <C-R>=expand("<cword>")<CR><CR>
    nmap <F10> :tn <CR><CR>
    nmap <S-F10> :tp <CR><CR>
