...
vim.g.gutentags_file_list_command = "fd -E '.*\\.(c|h|l|y|s|p|x|yang|ini|proto|sh|yaml|tf)$'" -- Specifies the command to generate the list of files for tag generation. The fd command with filters for C and header files is used here.
